...
<template>
    <header class="header">
        ...
        <div class="header_right">
            <a class="header_right-item" @click="openDrawer">
            ...
            <router-link to="/favorite">
                <a href="" class="header_right-item">
